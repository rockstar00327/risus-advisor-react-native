...
const GalleryStep2 = ({ navigation, route }) => {
  ...
  const handleNext = () => {
    navigation.navigate("UseAIFinalStep", {
      ...
      title: "This repost is creating by Gallery image upload",
      postId: postId,
    });
  };
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.progressContainer}>
        ...
        <View style={styles.stepLabelRow}>
          <Text style={styles.stepLabel}>Upload Images{"\n"}from gallery</Text>
